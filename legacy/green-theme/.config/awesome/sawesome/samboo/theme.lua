...
theme.wallpaper_cmd = { 'feh --bg-fill /home/sam/Pictures/785-green-and-yellow-paper-2560x1600-abstract-wallpaper.jpg' }
theme.lain_icons         = os.getenv("HOME") .. "/.config/awesome/lain/icons/layout/default/"
theme.layout_termfair    = theme.lain_icons .. "centerfair.png"
